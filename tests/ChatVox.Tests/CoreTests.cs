...
public class CoreTests
{
    ...
    {
        Assert.Equal("1.0.0-rc.5", typeof(Voices).Assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>()?.InformationalVersion);
    }
